...
Select any column in Explore mode to see facts. Use a pointer or move through
the columns with Tab and activate one with Enter or Space. Switch to Quiz Me to
test your knowledge with the same controls.
